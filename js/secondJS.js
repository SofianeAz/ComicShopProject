...
function createCartCard(parametre){
    ...
    newDivforfinal.setAttribute("class", "containerfluid border border-dark padding-xl");
    buyingList.append(newDivforfinal);

    // titre
    const titreEl = document.createElement('h3');
    titreEl.setAttribute('class', 'cart-titre border border-dark');
    newDivforfinal.appendChild(titreEl);
    titreEl.append(titre);

    // prix
    const prixEl = document.createElement('p');
    prixEl.setAttribute('class', 'cart-info border border-dark');
    newDivforfinal.appendChild(prixEl);
    prixEl.append(cartPrice);
    // nom
    const idEl = document.createElement('p');
    idEl.setAttribute('class', 'cart-info border border-dark');
    newDivforfinal.appendChild(idEl);
    idEl.append(serieName);
    // auteur
    const auteurEl = document.createElement('p');
    auteurEl.setAttribute('class', 'cart-info border border-dark');
    newDivforfinal.appendChild(auteurEl);
    auteurEl.append(authorName);
    //  info
    const infoEl = document.createElement('p');
    infoEl.setAttribute('class', 'cart-info border border-dark');
